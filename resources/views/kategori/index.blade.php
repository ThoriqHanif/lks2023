          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body" style="margin-top: -50px">
                ...
                <a data-toggle="modal" data-target="#ModalCreateKategori" class="btn btn-primary btn-sm mb-3 float-sm-right">+ Tambah Data</a>
                  ...
                  <tbody>
                    @foreach ($data as $item)
                        <tr>
                            ...
                            <td>
                                <a href="{{ '/kategori/'.$item->id.'/edit'}}" class="btn btn-warning btn-sm mb-2">Edit</a>
                                <form action="{{ '/kategori/'.$item->id }}" class="d-inline" method="post" onsubmit="return confirm('Yakin ingin hapus data?')">
                                    @method('DELETE')
                                    @csrf
