                  ...
                  <tbody>
                    @foreach ($data as $item)
                        <tr>
                            ...
                            <td>
                                <a href="{{ '/barang/'.$item->id }}" class="btn btn-secondary btn-sm mb-2">Detail</a>
                                <a href="{{ '/barang/'.$item->id.'/edit' }}" class="btn btn-warning btn-sm mb-2">Edit</a>
                                <form action="{{ '/barang/'.$item->id }}" method="POST" onsubmit="return confirm('Yakin ingin hapus data?')" class="d-inline">
