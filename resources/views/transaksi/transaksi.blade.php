          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form action="/beli" method="post" style="margin-top: -80px">
                    {{-- @method('PUT') --}}
                    @csrf
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="nama_buku" value="{{ $data->nama_buku }}" disabled>
                    </div>
                    <div class="form-group">
                      <label>Harga</label>
                  ...
                  <div class="card-footer">
                    ...
                    <a href="/beli" class="btn btn-secondary">Cancel</a>
                  </div>
                </form>
              </div>
              <!-- /.card -->
